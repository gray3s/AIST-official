...
check_cmd "vllm" "vllm"
check_cmd "sglang" "sglang"
check_cmd "text-generation-launcher" "text-generation-launcher"
check_cmd "tgi server" "text-generation-server"
check_cmd "lm studio cli" "lms"
check_cmd "localai" "local-ai"
check_cmd "jan" "jan"
check_cmd "jan server" "jan-server"
check_cmd "gpt4all cli" "gpt4all"
check_cmd "msty cli" "msty"
check_cmd "tabby api server" "tabbyapi"
check_cmd "exllamav2" "exllamav2"
check_cmd "mlx-lm" "mlx_lm.generate"
check_cmd "open webui" "open-webui"
check_cmd "llama-cpp-python server" "python3"
...
check_path "lm studio alternate models" "$HOME/.lmstudio/models"
check_path "jan data" "$HOME/jan"
check_path "gpt4all models" "$HOME/.cache/gpt4all"
check_path "msty models" "$HOME/.msty/models"
check_path "localai models" "$HOME/.localai/models"

echo
echo "Cloud-backed CLI executables, not local inference runtimes:"
check_cmd "codex cli cloud-backed" "codex"
check_cmd "claude cli cloud-backed" "claude"
check_cmd "gemini cli cloud-backed" "gemini"
